...
strategies = {
    ...
    '1day': {
        ...
        'policy': {
            ...
            'lr': 1.0e-4,
            'weight_file': '/mnt/shfiles1/kanren/data/amc-checkpoints/opds_15_225/opds_15_225_30r_4_80'
        }
    }
}
...
for step in range(8):
    ...
    strategy = copy.deepcopy(strategies['1day'])
    ...
    strategy['policy']['weight_file'] = f'/mnt/shfiles1/kanren/data/amc-checkpoints/opds_15_225/opds_{step_start}_{step_end}'
